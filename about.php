...
<html lang="en">
  ...
  <div class="container">
  <a class="navbar-brand" href="index.php">Tiket Kereta</a>
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav ml-auto">
      ...
      <a class="nav-item nav-link active" href="#">Service</a>
...
<br>
<h4 align="center"><b>About</b></h4><br><br>
     ...
     <div class="row justify-content-center">
         <div class="col-lg-10">
             <div class="row">
                <div class="col">
                    <p>KERETA API</p>
                    <P>Aplication Version 1.0<br>
                        Built Version: 1.0 <br>
                        Interface Language: Id-En <br>
                        Language: Id
                </P>
                </div>
                <div class="col">
                    <p>KONTRIBUTOR</p>
                    <P>IT Team Kereta Api<br>
                        Bambang Sugiarto (A11.2017.10696) <br>
                        Riski Priyadi (A11.2017.10385) <br>
                        Faezal Wahyu Hartono (A11.2017.10431)
                </P>
                </div>
             </div>
         </div>
